...
PILI_CAMERA_SDK_EXPORT flv_tag_p flv_create_tag();

PILI_CAMERA_SDK_EXPORT int flv_init_tag(flv_tag_p tag,
                 uint8_t   tag_type,
                 uint32_t  data_size,
                 uint32_t  timestamp,
                 uint32_t  stream_id,
...
PILI_CAMERA_SDK_EXPORT int flv_release_tag(flv_tag_p tag);
